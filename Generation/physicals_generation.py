...
class PhysicalsGeneration:
    ...
    def height_gen(self):
        ...
        minHeight = 68; maxHeight = 90; meanHeight = 79; sdHeight = 4
    ...
    def weight_gen(self):
        ...
        weightRange = {
            (68, 72): {'min': 160, 'max': 210, 'mean': 170, 'sd': 7},
    ...
    def strength_gen(self):
        ...
        strengthRange = {
            (68, 72, 165, 190): {'mean': 30, 'sd': 10},
            (68, 72, 191, 210): {'mean': 60, 'sd': 10},
            (73, 78, 185, 200): {'mean': 40, 'sd': 10},
            (73, 78, 201, 215): {'mean': 50, 'sd': 10},
            (73, 78, 216, 235): {'mean': 60, 'sd': 10},
            (79, 84, 215, 235): {'mean': 50, 'sd': 10},
            (79, 84, 236, 255): {'mean': 60, 'sd': 10},
            (79, 84, 256, 275): {'mean': 70, 'sd': 10},
            (85, 90, 250, 275): {'mean': 70, 'sd': 10},
            (85, 90, 276, 295): {'mean': 80, 'sd': 10},
            (85, 90, 296, 330): {'mean': 85, 'sd': 10}
        }
    ...
    def vertical_gen(self):
        ...
        # establish range
        verticalRange = {
            (68, 72, 165, 190): {'mean': 70, 'sd': 10},
            (68, 72, 191, 210): {'mean': 65, 'sd': 10},
            (73, 78, 185, 200): {'mean': 75, 'sd': 10},
            (73, 78, 201, 215): {'mean': 65, 'sd': 10},
            (73, 78, 216, 235): {'mean': 60, 'sd': 10},
            (79, 84, 215, 235): {'mean': 70, 'sd': 10},
            (79, 84, 236, 255): {'mean': 60, 'sd': 10},
            (79, 84, 256, 275): {'mean': 55, 'sd': 10},
            (85, 90, 250, 275): {'mean': 50, 'sd': 10},
            (85, 90, 276, 295): {'mean': 40, 'sd': 10},
            (85, 90, 296, 330): {'mean': 30, 'sd': 10},
        }
    ...
    def footwork_gen(self):
        ...
        # establish range
        footworkRange = {
            (68, 72, 170, 190): {'mean': 75, 'sd': 10},
            (68, 72, 191, 210): {'mean': 65, 'sd': 10},
            (73, 78, 185, 200): {'mean': 75, 'sd': 10},
            (73, 78, 201, 215): {'mean': 65, 'sd': 10},
            (73, 78, 216, 235): {'mean': 55, 'sd': 10},
            (79, 84, 215, 235): {'mean': 70, 'sd': 10},
            (79, 84, 236, 255): {'mean': 60, 'sd': 10},
            (79, 84, 256, 275): {'mean': 50, 'sd': 10},
            (85, 90, 250, 275): {'mean': 65, 'sd': 10},
            (85, 90, 276, 295): {'mean': 55, 'sd': 10},
            (85, 90, 296, 330): {'mean': 45, 'sd': 10},
        }
    ...
    def speed_gen(self):
        ...
        speedRange = {
            ...
            (79, 84, 236, 255): {'mean': 60, 'sd': 10},
            (79, 84, 256, 275): {'mean': 50, 'sd': 10},
            (85, 90, 250, 275): {'mean': 60, 'sd': 10},
            (85, 90, 276, 295): {'mean': 50, 'sd': 10},
            (85, 90, 296, 330): {'mean': 40, 'sd': 10},
        }
    ...
    def stamina_gen(self):
        ...
        # establish range
        staminaRange = {
            (68, 72, 165, 190): {'mean': 85, 'sd': 10},
            (68, 72, 191, 210): {'mean': 80, 'sd': 10},
            (73, 78, 185, 200): {'mean': 80, 'sd': 10},
            (73, 78, 201, 215): {'mean': 70, 'sd': 10},
            (73, 78, 216, 235): {'mean': 65, 'sd': 10},
            (79, 84, 215, 235): {'mean': 75, 'sd': 10},
            (79, 84, 236, 255): {'mean': 65, 'sd': 10},
            (79, 84, 256, 275): {'mean': 60, 'sd': 10},
            (85, 90, 250, 275): {'mean': 65, 'sd': 10},
            (85, 90, 276, 295): {'mean': 55, 'sd': 10},
            (85, 90, 296, 330): {'mean': 45, 'sd': 10},
        }
